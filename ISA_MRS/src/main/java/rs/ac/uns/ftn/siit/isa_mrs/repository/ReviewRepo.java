...
public interface ReviewRepo extends JpaRepository<Review, Long> {
    Page<Review> findAllByReservationRentalObjectAndAuthorIsActiveAndReviewType(RentalObject rentalObject, User author, ReviewType reviewType, Pageable pageable);
}
