...
public class RequestController {
    ...
    @GetMapping("/requests/page{offset}withSize{pageSize}sortBy{field}")
    public Collection<RequestDto> getRequestsWithPaginationAndSort(@PathVariable int offset, @PathVariable int pageSize, @PathVariable String field) {
        Collection<RequestDto> finalResult = new ArrayList<>();
