    ...
    <div class="col-8 pt-5">
      <div class="container-fluid">
        <div class="align-items-center">
          ...
          <!-- Reviews listing -->
          <CottageView v-for="(vacationRentalHouse, index) in this.cottages" v-on:requestManaged="firstPage" :key="index" :vacation-rental-house="vacationRentalHouse"/>
          <!-- Pagination -->
          <ul class="pagination justify-content-center">
            ...
            <li class="page-item">
              <h4 v-if="!cottages" class="no-result"> NO RESULTS!<font-awesome-icon icon="frown"/></h4>
...
import CottageView
  from "@/components/VacationRentalOwner/VacationRentalOwnerPage/components/AllCottagesView/CottageView/CottageView";
