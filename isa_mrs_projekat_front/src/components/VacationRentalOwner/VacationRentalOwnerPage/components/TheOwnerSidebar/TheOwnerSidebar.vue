<template>
  <div class="sidebar rounded-right" :style="{width:sidebarWidth}">
    ...
    <MenuLink to="/vacationRentalOwner/Reservations" icon="circle-check">Reservations</MenuLink>
...
import { faAngleDoubleLeft, faHome, faHouseChimneyWindow, faCircleCheck, faCalendarDays, faComments, faIdCard} from "@fortawesome/free-solid-svg-icons";
import MenuLink from "@/components/GeneralComponents/MenuLink";

library.add(faAngleDoubleLeft, faHome, faHouseChimneyWindow, faCircleCheck, faCalendarDays, faComments, faIdCard);
